...
public class Connexion {
  ...
  public void testConnexion() throws Exception {
    ...
    driver.findElement(By.xpath("//section[@id='main']/header/div"));
    assertEquals("VOTRE COMPTE", driver.findElement(By.xpath("//section[@id='main']/header/div")).getText());

    driver.findElement(By.xpath("//section[@id='main']/header/div/h2/span"));
      assertEquals("VOTRE COMPTE", driver.findElement(By.xpath("//section[@id='main']/header/div/h2/span")).getText());
    } catch (Error e) {
